...
class Calendar extends Component {
    ...
    renderYear(lastYear) {
        ...
        for (let i = 0; i < rows.length; i++) {
            ...
            for (let j = 0; j < rowItem.length; j++) {
                views.push(this.renderView(rowItem[j]));
            }
            rootView.push(this.subView(views));
        }
        return (
            <View>
                {rootView}
        ...
        return (
            <View style={this.style.week}>
                <TouchableOpacity
                    ...
                    onPress={() => {
                        this.props.selectedYearFunc(year);
                    }}
                >
    ...
    updateYears(arrow) {
        this.props.updateLastYear(arrow);
    ...
    render() {
        ...
        return (
            <GestureComponent {...gestureProps}>
                ...
                >
                    {this.renderHeader()}
                    {!this.props.showYears && this.renderMonth()}
                    {this.props.showYears && this.renderYear(this.props.lastYear)}
                </View>
            </GestureComponent>
        );
    }
