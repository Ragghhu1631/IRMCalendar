...
class CalendarHeader extends Component {
    ...
    shouldComponentUpdate(nextProps) {
        if (nextProps.month.toString('yyyy MM') !== this.props.month.toString('yyyy MM') || this.props.showYears !== nextProps.showYears || this.props.selectedYear !== nextProps.selectedYear) {
            return true;
        }
    ...
    onPressLeft = () => {
        if (this.props.showYears) {
            this.props.updateYears('left');
        } else {
    ...
    renderHeader = () => {
        ...
        return (
            <Fragment>
                ...
                {this.props.showYearsFunc ? <TouchableOpacity
                    style={[this.style.monthText, {alignContent: 'center', marginTop: 15}]}
                    hitSlop={{left: 20, right: 20, top: 20, bottom: 20}}
                    onPress={() => {
                        this.props.showYearsFunc();
                    }}
                >
                    <Image source={this.props.showYears ? require('../../img/up.png') : require('../../img/down.png')}
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                {!this.props.showYears && this.renderDayNames()}
            </View>
        );
    }
